  ...
  return (
    <main className="layout">
      ...
      <div className="container">
        ...
        <div className="row">
          <p className="buttontext">Thanks for clicking our code! We’re a group of students who want to make healthy eating fast and simple. We want to hear from everyone, but especially from those with diabetes. Please help us out by filling out our quick survey and letting us know how our product can best help you.</p>        
          <a className="button" href="https://princetonsurvey.az1.qualtrics.com/jfe/form/SV_09aNCANlxMlDYGi" target="_blank" rel="noreferrer"><span>take survey</span></a>
        </div>
        <div className="row">
          <p className="buttontext">We’d also love to chat with you over the phone or on Zoom! This would be a 15 minute informal interview to just hear what you have to say about nutrition and shopping.</p>
